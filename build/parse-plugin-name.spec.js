...
describe('parsePluginName', () => {
    ...
    test('should return reserved name if it stack does not have 3rd line', () => {
        ...
        const err = new Error();
        err.stack = stack;
        expect((0, parse_plugin_name_1.parsePluginName)(err)).toEqual('UNKNOWN_PLUGIN');
    });
    ...
    test('should return a plugin name a from stack', () => {
        ...
        const err = new Error();
        err.stack = stack;
        expect((0, parse_plugin_name_1.parsePluginName)(err)).toEqual('some-plugin-name');
    });
    test('should return a plugin name from a stack if it has a namespace', () => {
        ...
        const err = new Error();
        err.stack = stack;
        expect((0, parse_plugin_name_1.parsePluginName)(err)).toEqual('@some-org/some-plugin-name');
    });
});
