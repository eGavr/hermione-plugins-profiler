...
describe('entry-point', () => {
    ...
    const init = () => attachPlugin(hermione as unknown as Hermione, opts);
    ...
    test('should create writer for master', async () => {
        ...
        expect(JsonWriterMaster).toBeCalledWith('plugins-profiler', 'plugins.json');
    ...
    test('should create writer for worker', async () => {
        ...
        expect(JsonWriterWorker).toBeCalledWith('plugins-profiler', 'plugins.json');
        expect(JsonWriterMaster).not.toBeCalled();
    });

    describe('writer', () => {
        const getEmitAndWaitArgs = () => {
            const [calls] = (overwriteEmitAndWait as jest.Mock).mock.calls;
